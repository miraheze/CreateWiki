...
class CreateWikiJson implements ExpirationAwareness {
	...
	public function resetWiki() {
		...
		$this->cache->set( $this->cache->makeGlobalKey( 'CreateWiki', $this->wiki ), $this->initTime, self::TTL_HOUR * );
	...
	public function resetDatabaseList() {
		...
		$this->cache->set( $this->cache->makeGlobalKey( 'CreateWiki', 'databases' ), $this->initTime, self::TTL_HOUR * );
